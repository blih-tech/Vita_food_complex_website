          ...
          {QUALITY_CARDS.map((card) => (
            ...
            >
              ...
              <div className="relative z-10 flex-1 p-8 lg:p-20 flex flex-col justify-between h-full">
                ...
                <div
                  className={`absolute top-10 left-10 lg:left-20 font-['Outfit'] font-black text-[180px] md:text-[250px] lg:text-[320px] leading-none select-none pointer-events-none transition-transform duration-700 group-hover:scale-110 ${card.numberColor}`}
                >
                  {card.id}
                </div>
