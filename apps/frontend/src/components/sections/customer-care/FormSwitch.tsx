  ...
  return (
    <div className="flex justify-center relative z-30">
      <div className="relative flex bg-white p-[1.43px] rounded-[8.57px] shadow-lg border-[1.43px] border-white w-[320px] h-[52px] sm:w-[380px] sm:h-[56px] lg:w-[400px] lg:h-[60px]">
        ...
        >
          <div className={`relative w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 transition-opacity duration-300 ${activeTab === "feedback" ? "opacity-100" : "opacity-40 grayscale"}`}>
            <Image
          ...
          <span className="font-outfit font-semibold text-[15px] sm:text-[17px] lg:text-[22.86px] whitespace-nowrap">{t("feedback")}</span>
        </button>
        ...
        >
          <div className={`relative w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 transition-opacity duration-300 ${activeTab === "complaint" ? "opacity-100" : "opacity-40 grayscale"}`}>
            <Image
          ...
          <span className="font-outfit font-semibold text-[15px] sm:text-[17px] lg:text-[22.86px] whitespace-nowrap">{t("complaint")}</span>
        </button>
      </div>
    </div>
  );
