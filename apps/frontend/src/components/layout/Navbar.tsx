                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      ...
                      <div className="w-12 h-12 bg-[#FFF6E5] rounded-lg overflow-hidden relative flex items-center justify-center">
                        <Image
                          src="https://picsum.photos/100/100?random=81"
                          alt="Flour"
                          fill
                          className="object-cover"
                        />
                    ...
                    >
                      ...
                      <div className="w-12 h-12 bg-[#FFF0F0] rounded-lg overflow-hidden relative flex items-center justify-center">
                        <Image
                          src="https://picsum.photos/100/100?random=82"
                          alt="Recipes"
                          fill
                          className="object-cover"
                        />
            ...
            {activeDropdown === "people-planet" && (
              <div className="flex gap-12 w-full justify-between max-w-6xl mx-auto">
                ...
                <div className="flex flex-col gap-8 py-2 flex-1 pl-4">
                  ...
                  >
                    <h4 className="font-['Funnel_Display'] text-[18px] font-bold text-[#1A1A1A] group-hover:text-[#23B349] transition-colors">
                      Community
                    </h4>
              ...
              <div className="flex gap-12 w-full justify-between max-w-6xl mx-auto">
                ...
                <div className="flex flex-col gap-8 flex-1">
                  <Link
                    ...
                    className="flex flex-col group"
                  >
                    <h4 className="font-['Funnel_Display'] text-[20px] font-bold text-[#1A1A1A] group-hover:text-[#23B349] transition-colors">
                ...
                <div className="flex flex-col gap-3 flex-1">
                  ...
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="bg-[#F5F5F5] rounded-[12px] px-5 py-3.5 flex items-center group cursor-pointer hover:bg-gray-200 transition-colors"
                    >
              ...
              <div className="flex gap-12 w-full justify-between max-w-6xl mx-auto">
                ...
                <div className="flex flex-col gap-4 flex-1">
                  ...
                  {[1, 2].map((i) => (
                    <Link
                      key={i}
                      href="/news/vita-food-complex-ai-driven-food-solutions"
                      onClick={() => setActiveDropdown(null)}
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center px-2 pb-1">
                        <h5 className="font-['Funnel_Display'] text-[14px] font-bold text-[#1A1A1A] group-hover:text-[#23B349] transition-colors">
                          News & Articles Title
                        </h5>
